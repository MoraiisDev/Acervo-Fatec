...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Status atualizado com sucesso!'); window.location.href = 'Orgulho e Preconceito.php?id={$livro_id}';</script>";
    } else {
        echo "<script>alert('Erro ao atualizar status.'); window.location.href = 'Orgulho e Preconceito.php?id={$livro_id}';</script>";
    }
    $stmt->close();
}
?>
...
<body id="background">
    ...
    <div class="container" id="acervo">
        <div class="card" id="livro">
            <img class="card-img-top" src="https://m.media-amazon.com/images/I/71Xta4Nf7uL._AC_UF1000,1000_QL80_.jpg" alt="Capa do livro">
            <div class="card-body">
                <a href="https://static.tumblr.com/jzav6f0/hMVmlh1i5/jane_austen_-_orgulho_e_preconceito.pdf" class="btn btn-primary">Ler</a>
            </div>
        </div>
        
        <div id="sinopse">
            <h1>Orgulho e Preconceito</h1>
            <h5>Nome do autor: Jane Austen</h5>
            <h5>Data de lançamento: 1813</h5>
            <h5>Gênero: Romance, Sátira</h5>
            <h5>Sinopse do livro</h5>
            <p>Ambientado na Inglaterra rural do início do século XIX, Orgulho e Preconceito é uma das mais famosas obras de Jane Austen. A história gira em torno da família Bennet, composta por cinco irmãs, cujos destinos dependem de casamentos vantajosos, dada a condição financeira modesta da família.</p>
            <p>A protagonista, Elizabeth Bennet, é uma jovem inteligente, espirituosa e de opinião forte, que entra em choque com o reservado e orgulhoso Sr. Darcy, um homem rico e influente. Apesar das primeiras impressões negativas, uma série de mal-entendidos e situações os leva a questionar seus próprios julgamentos e sentimentos.</p>
            <p>O romance explora temas como as diferenças de classe, as pressões sociais, o papel da mulher e, claro, as complexidades do amor e do casamento. Com diálogos brilhantes e personagens inesquecíveis, a obra destaca o crescimento pessoal e a superação do orgulho e do preconceito mútuos como caminho para um amor verdadeiro.</p>
